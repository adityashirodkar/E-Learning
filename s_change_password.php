...
<div id="text">
	...
	<?php session_start();
		...
		$_SESSION['message'] = "";
	?>
	<form action="s_change_password.php" method="post">
	<table>
		<tr>
			<tr>
				<td>User Name: </td>
				...
				while($row = mysql_fetch_array($result))
				{
					if(($row['user_name'] == $_POST['user_name']) && ($row['password'] == $_POST['old_password']))
					{
						...
						if($_POST['new_password'] == $_POST['confirm_password'])
						{
							...
							$qu = "UPDATE student SET password = '".$_POST['new_password']."' WHERE user_name =  '".$_POST['user_name']."'";
							mysql_query($qu,$con) or die();
